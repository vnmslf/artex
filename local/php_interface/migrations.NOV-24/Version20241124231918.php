...
class Version20241124231918 extends Version
{
  ...
  'VALUE' => 'RUB,USD,EUR,UAH,BYN',
        ...
        $helper->Option()->saveOption(array (
  'MODULE_ID' => 'esol.exchange1c',
  'NAME' => '~bsm_stop_date',
  'VALUE' => 'AwZ0CWFUVFd8BABQVXELehYDCA==',
));
        $helper->Option()->saveOption(array (
  'MODULE_ID' => 'fileman',
  'NAME' => '~script_files',
...
В платформе детально проработаны и представлены на выбор 8 конфигураций универсального сайта. При этом количество возможных представлений настроек приближается к бесконечности. Все...',
  ...
  'NAME' => 'table_sprint_migration_aug-11',
  'VALUE' => '4',
));
        $helper->Option()->saveOption(array (
  'MODULE_ID' => 'sprint.migration',
  'NAME' => 'table_sprint_migration_nov-24',
  'VALUE' => '4',
));
        $helper->Option()->saveOption(array (
  'MODULE_ID' => 'sprint.migration',
  'NAME' => 'table_sprint_migration_okt-17',
  'VALUE' => '4',
));
        $helper->Option()->saveOption(array (
  'MODULE_ID' => 'sprint.migration',
  'NAME' => 'table_sprint_migration_okt-21',
  'VALUE' => '4',
));
        $helper->Option()->saveOption(array (
  'MODULE_ID' => 'sprint.migration',
  'NAME' => 'table_sprint_migration_sep-3',
  'VALUE' => '4',
));
        $helper->Option()->saveOption(array (
  'MODULE_ID' => 'sprint.migration',
  'NAME' => 'table_sprint_migration_versions',
  'VALUE' => '4',
));
        $helper->Option()->saveOption(array (
  'MODULE_ID' => 'sprint.migration',
